    ...
    <main>
        ...
        <section class="gj do ir hj sp jr i pg">
            ...
            <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
                <img src="/resources/images/shape-01.svg" alt="shape" class="xc 2xl:ud-block h t -ud-left-[10%] ua"/>
                <img src="/resources/images/shape-02.svg" alt="shape" class="xc 2xl:ud-block h u p va"/>
                <img src="/resources/images/shape-03.svg" alt="shape" class="xc 2xl:ud-block h v w va"/>
                <img src="/resources/images/shape-04.svg" alt="shape" class="h q r"/>
                <img src="/resources/images/hero.png" alt="Woman" class="h q r ua"/>
            </div>
            ...
            <div class="bb ze ki xn 2xl:ud-px-0">
                <div class="tc _o">
                    <div class="animate_left jn/2">
                        <h1 class="fk vj zp or kk wm wb">Our website is about trends and all news around the<br> world.</h1>
                        <p class="fq">
                            Explore the Pulse of the World with <span class="font-bold">TrendWave</span>: Dive into the latest news and trends across the globe with our curated content. Stay informed, stay ahead, and join the conversation on today's most talked-about stories. <span class="font-bold">TrendWave</span> – where news meets insight.
                        </p>
                        ...
                        <div class="tc tf yo zf mb">
                            ...
                            <span class="tc sf">
                <a href="#" class="inline-block ek xj kk wm"> Call us 06-00000000 </a>
                ...
                <div class="tc uf zo xf ap zf bp mq">
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg mh">
                            <img src="/resources/images/icon-01.svg" alt="Icon"/>
                        </div>
                        <div>
                            <h4 class="ek yj go kk wm xb">24/7 Support</h4>
                            <p>We are at your service any time.</p>
                        </div>
                    </div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg nh">
                            <img src="/resources/images/icon-02.svg" alt="Icon"/>
                        </div>
                        <div>
                            <h4 class="ek yj go kk wm xb">Take Ownership</h4>
                            <p>We can handle any problem around the world.</p>
                        </div>
                    </div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg oh">
                            <img src="/resources/images/icon-03.svg" alt="Icon"/>
                        </div>
                        <div>
                            <h4 class="ek yj go kk wm xb">Team Work</h4>
                            <p>Our success is about team work and good communication.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bb ze ki xn wq">
                <div class="tc wf gg qq">
                    ...
                    <div class="animate_left xc gn gg jn/2 i">
                        <div>
                            <img src="/resources/images/shape-05.svg" alt="Shape" class="h -ud-left-5 x"/>
                            <img src="/resources/images/about-01.png" alt="About" class="ib"/>
                            <img src="/resources/images/about-02.png" alt="About"/>
                        </div>
                        <div>
                            <img src="/resources/images/shape-06.svg" alt="Shape"/>
                            <img src="/resources/images/about-03.png" alt="About" class="ob gb"/>
                            <img src="/resources/images/shape-07.svg" alt="Shape" class="bb"/>
                        </div>
                    </div>
              ...
              <span class="tc wf xf be dd rg i gh ua">
                ...
                <img src="/resources/images/icon-play.svg" alt="Play"/>
              </span>
        ...
        <section class="i pg ji gp uq">
            ...
            <img src="/resources/images/shape-08.svg" alt="Shape Bg" class="h q r"/>
            <img src="/resources/images/shape-09.svg" alt="Shape" class="of h y z/2"/>
            <img src="/resources/images/shape-10.svg" alt="Shape" class="h _ aa"/>
            <img src="/resources/images/shape-11.svg" alt="Shape" class="of h m ba"/>
                ...
                <div class="wc qf pn xo gg cp">
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/ilyas.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Ilyas Chaoui</h4>
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/selma.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Salma El Gadi</h4>
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/kholod.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Kholod Sannak</h4>
                        <p>Scrum Master</p>
                    </div>
                </div>
            </div>
            <div class="bb ze i va ki xn xq jb jo">
                <div class="wc qf pn xo gg cp">
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/meryem.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Meryem Jammar</h4>
                        <p>Product Manager</p>
                    </div>
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/ali.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Ali Fertah</h4>
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="/resources/images/mouhcine.jpg" alt="Team"/>
                        ...
                        <h4 class="yj go kk wm ob zb">Mouhcine Essafi</h4>
                        <p>Web Designer</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bb ze ki xn yq mb en">
                <div class="wc qf pn xo ng">
                    ...
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="/resources/images/icon-04.svg" alt="Icon"/>
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="/resources/images/icon-05.svg" alt="Icon"/>
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="/resources/images/icon-06.svg" alt="Icon"/>
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="/resources/images/icon-07.svg" alt="Icon"/>
                ...
                <div class="projects-wrapper tc -ud-mx-5">
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="/resources/images/project-01.png" alt="Project"/>
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 digital">
                        <div class="c i pg sg z-1">
                            <img src="/resources/images/project-02.png" alt="Project"/>
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="/resources/images/project-04.png" alt="Project"/>
                    ...
                    <div class="project-item wi fb vd vo/3 digital ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="/resources/images/project-03.png" alt="Project"/>
                            ...
                            <div class="swiper-slide">
                                <div class="i hh rm sg vk xm bi qj">
                                    ...
                                    <div class="tc sf rn tn un zf dp">
                                        <img class="bf" src="/resources/images/testimonial.png" alt="User"/>

                                        <div>
                                            <img src="/resources/images/icon-quote.svg" alt="Quote"/>
                                            ...
                                            <div class="tc yf vf">
                                                ...
                                                <img class="rk" src="/resources/images/brand-light-02.svg" alt="Brand"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="i pg qh rm ji hp">
            <img src="/resources/images/shape-11.svg" alt="Shape" class="of h ga ha ke"/>
            <img src="/resources/images/shape-07.svg" alt="Shape" class="h ia o ae jf"/>
            <img src="/resources/images/shape-14.svg" alt="Shape" class="h ja ka"/>
            <img src="/resources/images/shape-15.svg" alt="Shape" class="h q p"/>
            ...
            <div class="bb ze ah ch pm hj xp ki xn 2xl:ud-px-49 bc">
                <div class="wc rf qn zf cp kq xf wf">
                    <a href="#" class="rc animate_top">
                        <img class="th wl ml il zl om" src="/resources/images/brand-light-01.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-01.svg" alt="Clients"/>
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="/resources/images/brand-light-02.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-02.svg" alt="Clients"/>
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="/resources/images/brand-light-03.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-03.svg" alt="Clients"/>
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="/resources/images/brand-light-04.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-04.svg" alt="Clients"/>
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="/resources/images/brand-light-05.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-05.svg" alt="Clients"/>
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="/resources/images/brand-light-06.svg" alt="Clients"/>
                        <img class="xc sk ml il zl nm" src="/resources/images/brand-dark-06.svg" alt="Clients"/>
                    </a>
                </div>
            </div>
        </section>
        ...
        <section id="support" class="i pg fh rm ji gp uq">
            <!-- Bg Shapes -->
            <img src="/resources/images/shape-06.svg" alt="Shape" class="h aa y"/>
            <img src="/resources/images/shape-03.svg" alt="Shape" class="h ca u"/>
            <img src="/resources/images/shape-07.svg" alt="Shape" class="h w da ee"/>
            <img src="/resources/images/shape-12.svg" alt="Shape" class="h p s"/>
            <img src="/resources/images/shape-13.svg" alt="Shape" class="h r q"/>
            ...
            <div class="i va bb ye ki xn wq jb mo">
                <div class="tc uf sn tf rn un zf xl:gap-10">
                    <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                        <!-- Bg Shapes -->
                        <img src="/resources/images/shape-03.svg" alt="Shape" class="h la x wd"/>
                        <img src="/resources/images/shape-06.svg" alt="Shape" class="h la ma ne kf"/>
