<div class="font-sans text-gray-900 antialiased bg-gray-100">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
        ...
        <div class="w-full sm:max-w-md my-6 px-6 py-12 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form method="POST" action="{{ route('preferences.add') }}">
                ...
                <div class="">
                    ...
                    <div class=" flex border rounded ">
                        <input id="preferences" type="text" name="preferences" placeholder="preferences"  class = 'w-full px-4 py-2.5 text-sm '>
