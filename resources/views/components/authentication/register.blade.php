<main>
    ...
    <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
        <!-- Bg Shapes -->
        <img src="/resources/images/shape-06.svg" alt="Shape" class="h j k"/>
        <img src="/resources/images/shape-03.svg" alt="Shape" class="h l m"/>
        <img src="/resources/images/shape-17.svg" alt="Shape" class="h n o"/>
        <img src="/resources/images/shape-18.svg" alt="Shape" class="h p q"/>
                ...
                <div class="wb">
                    ...
                    <label for="imageInput" class="relative mt-2 mr-48 mb-10 top-2 left-20 cursor-pointer ml-10 flex justify-center">
                        <div class="rounded-full overflow-hidden">
                            <img id="previewImage" style="width: 90px; height: 90px" src="/resources/images/photo.png"
                                 alt="User Picture">
                        </div>
                    </label>
