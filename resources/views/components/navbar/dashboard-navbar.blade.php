...
<nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-end" navbar-main navbar-scroll="true">
    <div class="flex items-center justify-between px-4 py-1 flex-wrap-inherit" style="width: 82%">
        <nav>
            <!-- breadcrumb -->
